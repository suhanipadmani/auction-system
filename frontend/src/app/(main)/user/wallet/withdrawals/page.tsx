    ...
    <div className="p-6 max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex items-center gap-4">
        ...
        <DashboardHeader
          ...
          subtitle="Track and manage all your payout and withdrawal requests."
        />
      </div>
              ...
              {isLoading ? (
                ...
                payoutRequestsData?.data?.map((req: any) => (
                  <TableRow key={req._id} className="border-border/40 hover:bg-white/5 transition-colors">
                    <TableCell className="font-bold text-lg text-rose-400">{formatCurrency(req.amount)}</TableCell>
